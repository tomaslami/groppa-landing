        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12">
          ...
          <div className="space-y-4">
            <Link href="#" className="flex items-center">
              <span className="text-2xl sm:text-3xl font-bold text-groppa-green">
                GROPPA
              </span>
            </Link>
            <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
              Profesionales en gestión inmobiliaria con humanidad y estrategia.
        ...
        <div className="border-t border-slate-600 mt-8 sm:mt-12 pt-6 sm:pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-xs sm:text-sm text-slate-400">
              &copy; {new Date().getFullYear()} GROPPA Inmobiliaria. Todos los
              derechos reservados.
            </p>
          </div>
        </div>
